...
<body>
  ...
  <body>
    ...
    <div class="content pt-3" id="content">
      ...
      <div class="container-fluid p-4">
        <div class="row g-3">
            ...
            <div class="card shadow-sm mb-4 staff-card" style="max-height: 400px;">
              ...
              <div class="card-body d-flex flex-column flex-lg-row align-items-center justify-content-center gap-4">
                <div class="profile-wrapper">
                  ...
                  $profilePhoto .= '?v=' . time();
                  ?>
                  <img src="<?php echo $profilePhoto; ?>" class="profile-img" alt="Profile Picture"
                    onerror="this.src='../assets/profile_pic/user.png'">
                </div>
                ...
                <div class="text-center text-lg-start ms-lg-5">
                  ...
                  <div class="d-flex justify-content-center justify-content-lg-start gap-2">
                    <button class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#editInfoModal">Edit
                      Info</button>
                    <?php if ($isAdmin): ?>
                      <button class="btn btn-danger btn-sm" id="btnRemove" data-bs-toggle="modal"
                        data-bs-target="#removeEmployeeModal">Remove Employee</button>
                    <?php endif; ?>
                  </div>
                </div>
              </div>
                    ...
                    <?php if ($loadSuccess && $employee): ?>
                      <form action="processes/update_employee.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          ...
                          <small>Select a new image to update the profile picture. Leave blank to keep the current
                            one.</small>
                        </div>
                        ...
                        <?php if ($isAdmin): ?>
                          <div class="form-group">
                            ...
                            <input type="text" id="roles" name="roles"
                              value="<?php echo htmlspecialchars($employee['roles']); ?>">
                          </div>
                        ...
                        <div class="form-actions">
                          <a href="staffinfo.php?id=<?php echo htmlspecialchars($employee['employee_id']); ?>"
            ...
            <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content p-4">
                ...
                <form id="removeEmployeeForm">
                  <div class="mb-3">
                    <label for="adminPasswordInput" class="form-label">Admin Password <span
                        class="text-danger">*</span></label>
                    <input type="password" class="form-control" id="adminPasswordInput" name="admin_password" required
                  ...
                  <div class="d-flex justify-content-center gap-3 flex-wrap mt-4">
                    ...
                    <button type="submit" class="btn btn-danger" id="confirmRemoveBtn">
                      ...
                      <span id="removeBtnSpinner" class="spinner-border spinner-border-sm ms-2" style="display: none;"
          ...
          <div class="col-xl-4">
                    ...
                    <div class="card shadow-sm border-0">
                      ...
                      <div class="card-body py-3 px-3">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                          ...
                          <button class="btn btn-success btn-sml" data-bs-toggle="modal"
                            data-bs-target="#addLeaveModal">ADD</button>
                        </div>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <textarea class="form-control mb-3" id="leaveReason" rows="3"
                      placeholder="Briefly explain your reason for leave"></textarea>

                    <label class="form-label">Attachment (Optional):</label>
                    <input type="file" class="form-control mb-2" id="leaveAttachment"
                      accept=".pdf,.jpg,.jpeg,.png,.doc,.docx">
                    <small class="text-muted d-block mb-1">
                      <i class="bi bi-info-circle"></i> You can attach medical certificates, documents, etc. (Max 5MB,
                      PDF/JPG/PNG/DOC/DOCX)
                    </small>
                    <div class="alert alert-danger mb-3" id="fileSizeWarning"
                      style="display: none; font-size: 0.85rem;">
                      <i class="bi bi-exclamation-triangle"></i> File size exceeds 5MB limit. Please choose a smaller
                      file.
                    </div>

                    <div class="alert alert-info mb-3" id="monthlyLimitInfo" style="font-size: 0.9rem;">
                      <i class="bi bi-info-circle"></i> <strong>Monthly Limit:</strong> <span
                        id="monthlyLimitText">Checking...</span>
                    </div>
              ...
              <div class="card-body" style="min-height: 800px; max-height: 800px; overflow-y: auto;">
                <?php if ($isAdmin): ?>
                  <button class="btn btn-success w-100 mb-3" id="exportDtrBtn"
                    onclick="redirectToIndividualReport()">Export DTR</button>
                <?php endif; ?>

                <div class="d-flex justify-content-between align-items-center mb-2">
                  <div><small class="text-muted">Daily Time Record</small></div>
                  <a href="../attendancerep/indirep.php?id=<?php echo htmlspecialchars($employee['employee_id']); ?>"
                    class="small">See more...</a>
                </div>
            ...
            <div class="modal fade" id="editTimeOutModal" tabindex="-1" aria-labelledby="editTimeOutModalLabel"
              aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  <div class="modal-header">
      ...
      <div class="card mb-3 metrics-card" id="performanceMetricsCard">
                ...
                <div class="schedule-section">
                  ...
                  <div class="form-row" id="faculty-fields">
                    <div class="form-group">
                      ...
                      <small style="color: #666; font-size: 0.8em;">Click dropdown arrow or start typing to see existing
                        classes</small>
                    </div>
                    <div class="form-group">
