  ...
  <div class="row mb-3">
    <div class="col-12">
      <div class="header-bar d-flex align-items-center">
        <i class="bi bi-arrow-left-circle fs-4 me-2 text-primary" id="backBtn" style="cursor: pointer;"></i>
        <h4 class="mb-0 fw-bold text-dark">Staff Information</h4>
      </div>
    </div>
  </div>

  <div class="row g-3">
    <!-- LEFT COLUMN: Staff Info and Performance Metrics -->
    <div class="col-12 col-lg-8">
      <!-- Staff Information Card -->
      <div class="card shadow-sm staff-info-card mb-3">
        ...
        <div class="card-body p-4">
          <div class="row align-items-center">
            ...
            <div class="col-12 col-md-4 col-lg-3 text-center mb-3 mb-md-0">
              ...
              ?>
              <img src="<?php echo '../' . $employee['profile_photo']; ?>" 
            ...
            <div class="col-12 col-md-8 col-lg-9">
              <div class="row">
                <div class="col-12 col-lg-8">
                  <h3 class="fw-bold mb-2 text-dark"><?php echo $viewer->getFullName(); ?></h3>
                  <div class="mb-3">
                    <span class="badge bg-primary mb-2"><?php echo htmlspecialchars($employee['employee_id']); ?></span>
                    <p class="mb-1 text-muted">
                      <i class="bi bi-briefcase me-1"></i>
                      <?php echo htmlspecialchars($employee['roles']); ?> | <?php echo htmlspecialchars($employee['position']); ?>
                    </p>
                    <p class="mb-1 text-muted">
                ...
                <div class="col-12 col-lg-4">
                  <div class="d-flex flex-column gap-2">
                    <button class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#editInfoModal">
                      <i class="bi bi-pencil-square me-1"></i>Edit Info
                    </button>
                    <button class="btn btn-outline-danger btn-sm" id="btnRemove" data-bs-toggle="modal" data-bs-target="#removeEmployeeModal">
...
document.addEventListener('DOMContentLoaded', loadPerformanceMetrics);
    ...
    <!-- RIGHT COLUMN (Calendar, Leave, Manual Attendance, Export DTR) -->
    <div class="col-12 col-lg-4">
      ...
      <div class="card shadow-sm mb-3">
        <div class="card-header bg-white border-bottom">
          <div class="d-flex justify-content-between align-items-center">
            <h6 class="mb-0 fw-bold text-dark">
              <i class="bi bi-calendar-check me-2"></i>Scheduled Leave
            </h6>
        ...
        <div class="card-body">
          ...
          <!-- Leave Entries -->
          <div id="leaveList" class="leave-list-container">
      ...
      <div class="card shadow-sm mb-3">
        <div class="card-header bg-white border-bottom">
          <div class="d-flex justify-content-between align-items-center">
            ...
            <h6 class="mb-0 fw-bold text-dark" id="calendarTitle">Month Year</h6>
    ...
    <script>
      ...
      <div class="card shadow-sm mb-3">
        <div class="card-body p-3">
          <button class="btn btn-success w-100 mb-2" id="openAttendance">
    ...
    saveBtn.addEventListener('click', async () => {
      ...
      <div class="card shadow-sm">
        <div class="card-header bg-white border-bottom">
          <div class="d-flex justify-content-between align-items-center">
            <h6 class="mb-0 fw-bold text-dark">
              <i class="bi bi-clock-history me-2"></i>Daily Time Record
            </h6>
            <a href="../attendancerep/indirep.php?id=<?php echo htmlspecialchars($employee['employee_id']); ?>" 
               class="btn btn-link btn-sm p-0 text-decoration-none">See more...</a>
          </div>
        </div>
        <div class="card-body">
