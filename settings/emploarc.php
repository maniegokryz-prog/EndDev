  ...
  <body>
    ...
    <div class="sidebar d-flex flex-column pt-5" id="sidebar">
      <div class="profile text-center p-3 mt-4">
        ...
        if (!empty($currentUser['profile_photo']) && $currentUser['profile_photo'] !== 'N/A') {
          $checkPath = dirname(__DIR__) . '/' . $currentUser['profile_photo'];
          if (file_exists($checkPath)) {
            $profilePhoto = '../' . htmlspecialchars($currentUser['profile_photo'], ENT_QUOTES, 'UTF-8');
          }
        }
        ?>
        <img src="<?php echo $profilePhoto . '?v=' . time(); ?>" alt="Profile" class="rounded-circle mb-2" width="70"
          height="70" onerror="this.src='../assets/profile_pic/user.png';">
    ...
    <div class="content pt-3" id="content">
      <div class="container-fluid">
          ...
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content p-4">
              ...
              <div class="modal-body">
                ...
                <form id="deleteForm">
                  <div class="mb-3">
                    <label for="deletePasswordInput" class="form-label">Admin Password <span
          ...
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content p-4">
              ...
              <div class="modal-body">
                ...
                <form id="restoreForm">
                  <div class="mb-3">
                    <label for="restorePasswordInput" class="form-label">Admin Password <span
                        class="text-danger">*</span></label>
                    <input type="password" class="form-control" id="restorePasswordInput" required
                      placeholder="Enter your password">
        ...
        <!-- Center Alert -->
        <div id="centerAlert"
          class="position-fixed top-50 start-50 translate-middle bg-warning text-dark fw-semibold py-3 px-4 rounded shadow"
